...
router.route('/').get(function (req, res) {
    assignmentExamController.get().then(function (data) {
...
router.route('/:assignmentExamCode').get(function (req, res) {
    assignmentExamController.getOne(req.params.assignmentExamCode).then(function (data) {
        res.status(data.status).send(
            data.data
        );
    }).catch(error => {
...
router.route('/:assignmentExamCode').put(function (req, res) {
